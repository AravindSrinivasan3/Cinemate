...
const MovieDetail = () => {
  ...
  const image = movie.poster_path ? `https://image.tmdb.org/t/p/w500/${movie.poster_path}` : PageNotFoundImage ;
  useEffect(() => {
    async function fetchMovie(){
      const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=cc695aa71274fbea63c1d08a870ffbc1`);
